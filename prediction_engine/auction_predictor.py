...
class AuctionPredictor(nn.Module):
    def __init__(self, n_items, input_size=5, encoder_hidden_size=16, decoder_hidden_size=16, item_index=3, embedding_size=16, dropout_p=0.1, bidirectional=True):
        ...
        self.encoder = Encoder(n_items, input_size=input_size, item_index=item_index, embedding_size=embedding_size, hidden_size=encoder_hidden_size, dropout_p=dropout_p, bidirectional=bidirectional)

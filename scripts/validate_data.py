...
def main(args):
    ...
    auctions_folder = args.data_dir
    output_folder = args.output_dir

    # Iterate over each day folder
    for day_folder in tqdm(os.listdir(auctions_folder)):
    ...
    with open(os.path.join(output_folder, 'data_report.csv'), 'w', newline='') as csvfile:
